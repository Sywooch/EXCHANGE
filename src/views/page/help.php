...
<div class="full-page">
	<div class="container">
		...
		<div class="text help-text">
			...
			<div class="check-title">Проверка статуса вопроса</div>
			<div class="hint">Если вы уже отправили свой вопрос в службу техподдержки и ждете на него ответ, то введите номера вопроса ниже, чтобы проверить текущий статус. Номер можно посмотреть на почте, которую вы указали при заполнении формы вопроса.</div>
			<div class="ticket"><div class="ticket-wrapper"><span>введите номер тикета</span> <input type="text" /> <input type="submit" value="перейти" /><div class="clearfix"></div></div></div>
		</div>
	</div>
</div><!-- /.full-page -->
