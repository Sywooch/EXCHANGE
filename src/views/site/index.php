        ...
        <div class="bid-block">
            ...
            <form class="form order-form" action="<?=Url::to(['site/process-order'])?>"
                ...
                <div class="fields">
                    ...
                    <div class="hint">По курсу: <span id="form_course"></span> 1.0000 {{directionActive.from.type}} {{directionActive.from.title}} = {{directionActive.course}} {{directionActive.to.type}} {{directionActive.to.title}} (мин. комиссия {{directionActive.min_comission}})</div>
                    <!--<div class="row">
